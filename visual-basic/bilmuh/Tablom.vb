'Bu Sýnýflar Halil Ýbrahim KALKAN tarafýndan programlanmýþtýr.
'e-posta : hi_kalkan@yahoo.com
'web     : http://www.kalkan.cjb.net
Imports System
Imports System.Data
'Tablonun biçim bilgileri 
Public Class TablomBicim
...
Public Class Satirim
    ...
    Public Sub HucreEkle(ByVal YeniHucre As Hucrem)
...
Public Class Tablom
    ...
    'Tablonun biçimi
    Private gBicim As New TablomBicim
    'Tablonun Html kodu
    ...
    Public Property Bicim() As TablomBicim
        Get
            Bicim = gBicim
        End Get
        Set(ByVal YeniBicim As TablomBicim)
            gBicim = YeniBicim
        End Set
    End Property
    ...
    Public Sub SatirEkle(ByVal YeniSatir As Satirim)
        gSatirlar.Add(YeniSatir, SatirSayisi + 1)
        gSatirSayisi = gSatirSayisi + 1
    End Sub
    'Yeni kolon eklemek için
    Public Sub KolonEkle(ByVal YeniKolon As Kolonum)
    ...
    Public Sub HtmlKoduUret(Optional ByVal KolonlarOlsunMu As Boolean = True)
        'deðiþkenler
        Dim kod As String ' geçici kod
        Dim i As Integer ' sayaç deðiþkenleri
        Dim birSatir As Satirim ' geçici satýr
    ...
    Public Sub VeriTablosuAl(ByVal VT As DataTable, Optional ByVal VTBaslik As Boolean = False)
        ...
        Dim birKolon As Kolonum
        Dim BirHucre As Hucrem
        Dim BirSatir As Satirim
