...
<HTML>
	...
	<body>
		<p class="DuzYazi" align="center">
			...
			<asp:Label ID="lblYonetici" Runat="server">[<a href="../yonetici/default.aspx">Yönetici 
					Bölümü</a>]</asp:Label>
				...
				<table width="90%" align="center" bgcolor="#000000" cellpadding="1" cellspacing="1">
					<tr>
						...
						<td align='center' bgcolor='#dddddd' width='20%' class='DuzYazi'>
							<a href="default.aspx?Sayfa=SifreDegistir"><Font color="#000000">Þifre Deðiþtir</Font></a>
						</td>
					</tr>
				</table>
			</div>
